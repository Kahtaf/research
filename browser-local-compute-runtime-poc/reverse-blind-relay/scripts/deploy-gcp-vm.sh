...
PUBLIC_CERT_HOST_SUFFIX="${PUBLIC_CERT_HOST_SUFFIX:-$SESSION_HOST_SUFFIX}"
ACME_DIRECTORY_URL="${ACME_DIRECTORY_URL:-}"
ACME_EMAIL="${ACME_EMAIL:-}"
ACME_TERMS_AGREED="${ACME_TERMS_AGREED:-false}"
ACME_ACCOUNT_KEY_FILE="${ACME_ACCOUNT_KEY_FILE:-$REMOTE_DIR/acme-account-key.pem}"
ACME_CHALLENGE_MODE="${ACME_CHALLENGE_MODE:-http-01}"
ACME_DNS_PROPAGATION_MS="${ACME_DNS_PROPAGATION_MS:-5000}"
ACME_SKIP_CHALLENGE_VERIFICATION="${ACME_SKIP_CHALLENGE_VERIFICATION:-false}"
...
Environment=ACME_HTTP_PORT=${ACME_HTTP_PORT}
...
Environment=PUBLIC_CERT_HOST_SUFFIX=${PUBLIC_CERT_HOST_SUFFIX}
Environment=ACME_DIRECTORY_URL=${ACME_DIRECTORY_URL}
Environment=ACME_EMAIL=${ACME_EMAIL}
Environment=ACME_TERMS_AGREED=${ACME_TERMS_AGREED}
Environment=ACME_ACCOUNT_KEY_FILE=${ACME_ACCOUNT_KEY_FILE}
Environment=ACME_CHALLENGE_MODE=${ACME_CHALLENGE_MODE}
Environment=ACME_DNS_PROPAGATION_MS=${ACME_DNS_PROPAGATION_MS}
Environment=ACME_SKIP_CHALLENGE_VERIFICATION=${ACME_SKIP_CHALLENGE_VERIFICATION}
Environment=ACME_EAB_KID=${ACME_EAB_KID}
Environment=ACME_EAB_HMAC_KEY=${ACME_EAB_HMAC_KEY}
